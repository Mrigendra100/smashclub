                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <Link href="/dashboard" className="flex items-center gap-3 group">
                            ...
                            <h1 className="text-2xl sm:text-3xl font-bold text-gradient">Terms & Conditions</h1>
                        </Link>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="glass-effect rounded-3xl p-8 sm:p-12 border border-white/10">
                    ...
                    <div className="space-y-8 text-gray-300 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white mb-4">2. Booking Rules</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white mb-4">5. Membership Passes</h2>
                            <p>
