        ...
        <div className="min-h-screen bg-rich-white pb-12">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <Link href="/dashboard" className="flex items-center gap-3 group">
                            ...
                            <h1 className="text-2xl sm:text-3xl font-bold text-court-deep">Cancellations & Refunds</h1>
                        </Link>
                    </div>
                </div>
            </header>
            ...
            <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="bg-white rounded-3xl p-8 sm:p-12 border border-slate-200 shadow-sm">
                    <h1 className="text-3xl sm:text-4xl font-bold text-slate-800 mb-8">Cancellations and Refunds Policy</h1>

                    <div className="space-y-8 text-slate-600 leading-relaxed">
                        <section>
                            <h2 className="text-xl font-bold text-court-deep mb-4">1. Booking Cancellations</h2>
                            <p className="mb-4">
                            ...
                            <ul className="list-disc pl-5 space-y-2">
                                <li><strong className="text-slate-800">More than 24 hours notice:</strong> Full refund credited to your original payment method.</li>
                                <li><strong className="text-slate-800">12-24 hours notice:</strong> 50% refund credited to your account.</li>
                                <li><strong className="text-slate-800">Less than 12 hours notice:</strong> No refund available.</li>
                            </ul>
                        </section>

                        <section>
                            <h2 className="text-xl font-bold text-court-deep mb-4">2. Refund Process</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-court-deep mb-4">3. Membership Passes</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-court-deep mb-4">4. Weather Policy</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-court-deep mb-4">5. Contact for Refunds</h2>
                            <p>
                                If you believe you are eligible for a refund or have issues with a cancellation, please contact our support team at <span className="text-court-green">support@smashclub.com</span> or call us at <span className="text-court-green">+91 9818559711</span>.
                            </p>
                        </section>
